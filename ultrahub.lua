...
local Window = Library.CreateLib("CronyHub", "Midnight")

-- Game Scripts
local Tab = Window:NewTab("scripts")
local Section = Tab:NewSection("scripts")
Section:NewButton("Funky Friday", "1940", function()
...
Section:NewButton("DAhood", "YBA", function()
...
Section:NewButton("Bed Wars", "Executes VAPE V4 (Bed Wars)", function()
...
Section:NewButton("YBA", "YBA", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/zakater5/LuaRepo/main/YBA/v3.lua"))()
end)
Section:NewButton("big painball gui", "1999", function()
loadstring(game:HttpGet("https://realzzhub.xyz/script.lua"))()
end)
Section:NewButton("Vynixuis (doors)", "doors", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Vynixius/main/Doors/Script.lua"))()
end)

Section:NewButton("realzz(Phantom Forces)", "doors", function()
loadstring(game:HttpGet("https://realzzhub.xyz/script.lua"))()
end)
...
local Section = Tab:NewSection("FeScripts")
Section:NewButton("SNAKE", "LOL", function()
...
Section:NewButton("astron(om)#3516", "Bruh", function()
